(()=>{
  ...
  const CHAPTERS={
    ...
    313:[
      {seconds:100,title:'Proč se nám zdá, že čas plyne rychleji, když stárneme?'},{seconds:255,title:'Co by se stalo, kdyby se Země přestala otáčet?'},{seconds:422,title:'Proč mají některé planety prstence a jiné ne?'},{seconds:580,title:'Může být vesmír živý?'},{seconds:730,title:'Proč se světlo ohýbá kolem černé díry?'},{seconds:895,title:'Co by se stalo, kdyby se Slunce okamžitě vypnulo?'},{seconds:1040,title:'Proč se nám zdají hvězdy malé, když jsou obrovské?'},{seconds:1180,title:'Jak funguje GPS a relativistické korekce?'},{seconds:1325,title:'Může být gravitace tah místo zakřivení?'},{seconds:1490,title:'Proč se vesmír zdá prázdný, když je plný částic?'},{seconds:1650,title:'Může být čas cestovatelný?'},{seconds:1810,title:'Co je největší záhada současné fyziky?'}
    ],
    319:[
      {seconds:141,title:'Proč hvězdy blikají a planety ne?'},{seconds:222,title:'Proč si lidé představí milion eur, ale ne milion let?'},{seconds:465,title:'Plyne čas v prázdném vesmíru rychleji než u černé díry?'},{seconds:572,title:'Je naše Slunce polárkou pro jinou planetu?'},{seconds:667,title:'Můžou vznikat nová souhvězdí a zanikat stará?'},{seconds:818,title:'Existuje teoretická fyzika bez těžké matematiky?'},{seconds:908,title:'Existují bludné černé díry?'},{seconds:1011,title:'Co je kvantová mechanika a jak ovlivňuje realitu?'},{seconds:1162,title:'Můžeme vytvořit mutanta?'},{seconds:1369,title:'Co se stane, když ve vodě nahradíme vodík deuteriem?'},{seconds:1547,title:'Je větší šance uplatnit se s fyzikou nebo matematikou?'},{seconds:1839,title:'Jaký čas platí na ISS?'}
    ],
    326:[
