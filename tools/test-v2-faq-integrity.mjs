...
const expected=[350,346,340,337,332,326,319,313,300,295,289,284,278,272,270,263,257,248,244,226,218,211,203,190,179,170,158,143,138,133,128,119,112,100,89,82,75,69,60,51,35,26,17];
...
const q350=byEpisode.get(350)||[];
assert(q350.length===15,`Episode 350 has ${q350.length} questions, expected 15`);
