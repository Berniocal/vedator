...
const episode220=data.nonquestions.episodes['220'];
if(episode220?.cs?.length!==10||episode220?.sk?.length!==10)fail('Episode 220 must contain 10 CZ and 10 SK sections');
if(episode220.cs.some((item,index)=>item.time!==episode220.sk[index]?.time))fail('Episode 220 CZ/SK timestamps differ');
